...
function stegosaurPlan(): BodyPlan {
  return {
    ...
    head: { position: [0, 0.2, 1.64], scale: [0.26, 0.22, 0.46] },
    face: { position: [0, 0.18, 1.76], scale: [0.22, 0.18, 0.32] },
    snout: { position: [0, 0.15, 1.88], scale: [0.15, 0.12, 0.22] },
    jaw: [0, 0.12, 1.96],
    eye: { x: 0.09, y: 0.24, z: 1.68 },
    brow: { x: 0.06, y: 0.28, z: 1.56 },
    faceSpiralScale: 0,
